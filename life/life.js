...
function onClick(e) {
    ...
    if (ship.shipPosition != undefined) {
        clickPosition = new Point(x, y).add(worldCoord);
    }
    clickCircle = new Item(new Point(x, y).add(worldCoord), "255, 255, 255");
    clickCircle.type = 0;
    clickCircle.dieTime = +new Date() + 500;
    clickCircle.typeClick = 1;
    clickCircle.grayValue = 1;
    listObj.push(clickCircle);
}
